 ...
 * @author Julio
 */
public class ButtonColumnAdicao extends AbstractCellEditor
    ...
    public ButtonColumnAdicao(JTable table, int column) {
        super();
        this.table = table;
    ...
    public ButtonColumnAdicao(JTable table, int column, TableModelItemVenda modelItemVenda, JTextField total, JTextField troco) {
        this(table, column);
    ...
    public Component getTableCellRendererComponent(
        ...
        renderButton.setIcon(new ImageIcon(getClass().getResource("/img/plus-6-32.png")));
        return renderButton;
    }
